...
Display daily NCAA action on an raspberry pi powered LED matrix. Currently supports 64x32 boards only.
...
The display will rotate through all of the NCAA action for the current day.
...
```
git clone --recursive https://github.com/alexanderthebadatcoding/NCAA-led
cd NCAA-led-scoreboard/
